				...
				adsManager.addEventListener(AdEvent.IMPRESSION,
					function(ev:AdEvent):void{
						...
						if (currentAd.position == PositionedAdInfo2.PRE){
							TrackingControl.sendEvent(TrackingCategory.ADVERTISING, "play PRE roll");
						}
						if (currentAd.position == PositionedAdInfo2.MID){
							TrackingControl.sendEvent(TrackingCategory.ADVERTISING, "play MID roll");
						}
						if (currentAd.position == PositionedAdInfo2.POST){
							TrackingControl.sendEvent(TrackingCategory.ADVERTISING, "play POST roll");
						}
					});
