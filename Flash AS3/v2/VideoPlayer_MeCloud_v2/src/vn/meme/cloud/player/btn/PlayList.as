package vn.meme.cloud.player.btn
{
	...
	public class PlayList extends VideoPlayerButton
	{
		
		[Embed(source="asset/btn-playlist.png")]
		public static var asset:Class;
		public function PlayList()
		{
			super(VideoPlayerEvent.PLAYLIST);
		...
		protected override function onMouseOver(ev:MouseEvent=null):void{
			...
			PlayerTooltip.getInstance().show("Playlist", point.x, point.y);	
		}
