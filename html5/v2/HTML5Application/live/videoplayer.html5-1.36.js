            ...
            function a(t) {
                ...
                switch (console.log("[MemePlayer] AD EVENT", t, n, n.getAdId()), t.type) {
                    case google.ima.AdEvent.Type.LOADED:
                        (n.getWidth() < 20 || n.getHeight() < 20) && (console.log("[MemePlayer]", "Ad error size"), i.adManager.skip()), console.log("[MemePlayer]", "Ad loaded ", n), i.showAdContainer(), P || i.components.load.hide(), n.isLinear() ? f.adType === E && !n.isSkippable() && f.skippable ? i.showAdControls() : i.hideAdControls() : (i.hideAdControls(), i.isPlaying ? P && r("iPhone cannot display overlay ad.") : (P && e.exitFullScreen(), i.setupLinearBanner(n))), i.components.ad.resetAdHeight();
                        break;
    ...
    D.prototype = {
        ...
        init: function() {
            if (!P) {
                ...
                l.title = "Xem toàn màn hình", l.className = "controls", o = l.style, o.setProperty("display", "none"), o.setProperty("margin", "0", "important"), o.setProperty("padding", "0", "important"), r(l, "click", function() {
