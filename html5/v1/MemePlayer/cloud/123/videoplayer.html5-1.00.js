(function(w, d) {
        ...
        function onAdEvent(adEvent) {
            ...
            switch (adEvent.type) {
                ...
                case google.ima.AdEvent.Type.STARTED:
                    ...
                    console.log('** ' + adsManager.isCustomPlaybackUsed());
                    ...
                    if (ad.isLinear() || !player.isPlaying) {
                        ...
                        if (d.fullScreen || d.mozFullScreen || d.webkitIsFullScreen || d.msFullscreenElement)
                            player.components.ad.setTopAdBackground(0);
                        if (!ad.b.vpaid) {
                            ...
                            if (contentType && contentType.indexOf("video") === 0) {
                                ...
                                if (!ad.isSkippable() && currentAd.skippable) {
                                    if (currentAd.adType === VAST) {
                                        player.showAdControls();
                                        if (isIphone || isIpad) { // do khi video qc end, khong ban ra event "Complete"
                                            // timeoutMobileTimer = setInterval(function() {
                                            //       console.log(adsManager.getRemainingTime());
                                            //       if (adsManager.getRemainingTime <= 2)
                                            //            adsManager.skip();
                                            //  }, 1000);
                                        }
                    ...
                    if ((adsInfo.position === MIDROLL) && !ad.isLinear() && !player.isPlaying) {
                        console.log('keep moving forward');
                        //player.components.load.show();
                        //player.components.ad.element.style.removeProperty("background-color");
                    }
    ...
    MemeVideoComp.create("stage", {
        ...
        init: function() {
            ...
            e.oncanplay = function() {
                ...
                if (isIpad || isIphone) {
                    console.log('abcdef ' + self.currentTime());
                    console.log(self.element.readyState);
                }
            };
        ...
        checkRelatedVideo: function() {
            ...
            if (p.components.relatedVideo && p.components.relatedVideo.isRelatedVideo()) {
                ...
                //p.components.relatedVideo.setContentVideoHeight(p.size.height);
                console.log(p.size.height + ' ' + p.size.stageHeight);
            } else {
    ...
    MemeVideoComp.create("subtitleBtn", {
            ...
            e.languagesFrame.onclick = function(ev) {
                ...
                if (id === "btn-back-subtitles") {
                    ...
                    if (lang === 'OFF') {
                        ...
                        checkOnOff.checked = true;
                        btnSub.classList.add('active');
                        e.videoTag.textTracks[e.currentLang].mode = 'hidden'; //showing
                        e.setSubOn();
                        e.showSrtSub();
                    }
        ...
        showSubtitle: function() {
            ...
            if (tracks && len > 0) {
                ...
                tracks[self.currentLang].mode = 'hidden'; //showing
            }
        },
        checkSubOn: function() {
            return this.isSubOn;
        ...
        loadSubtitle: function(subtitleData) {
            ...
            cp.stage.setTracks(subtitleData.tracks);
            ...
            cp.subtitleBtn.parseSubtitleSrt(subtitleData.tracks);
            ...
            if (subtitleData.autotrack) {
                ...
                tracks[isDefaultSub].mode = 'hidden'; //showing
                sub.setSubOn();
    ...
    MemeVideoComp.create("ad", {
        ...
        setTopAdBackground: function(value) {
    ...
    MemeVideoComp.create("relatedVideo", {
        ...
        createElementVideoItem: function(player, videoItem, index, videoItemLength) {
            var self = this;
            ...
            */
            ...
            divInfo.addEventListener('click', function(ev) {
                if (ev.path[0].id !== (undefined || "")) {
                    MeCloudVideoPlayer.loadEmbed(player.session, self.getVideoItems()[ev.path[0].id.split('item-index-')[1]]);
                }
            });
            ...
            */
            ...
            aHref.addEventListener('click', function(ev) {
                if (ev.path[1].id !== (undefined || "")) {
                    ...
                    MeCloudVideoPlayer.loadEmbed(player.session, self.getVideoItems()[ev.path[1].id.split('item-index-')[1]]);
                }
            });
            return aHref;
        },
        ...
        createElementVideoRelated: function(player, videoList, length) {
            ...
            if (className === 'one-item mobile')
                divContentVideo.style.setProperty("padding", "20% 20%", "important");
            ...
            for (var i = 0; i < length; i++) {
                divContentVideo.appendChild(this.createElementVideoItem(player, videoList[i], i, length));
            };
